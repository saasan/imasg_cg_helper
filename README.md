...
----------------
* マイスタジオ下部に自分のIDを表示
* アコーディオンメニュー内に指定IDへのジャンプ機能を追加
* レッスン画面の操作リンクを変更
* レッスン画面のレッスン情報を表示
* 特訓画面に操作リンクを追加
* イベント用ユニット編成画面のメンバー追加ボタンの生成ロジックを変更
* LIVEツアーカーニバル用発揮値チェック機能を追加
* AndroidでFlash画面に追加したリンクの表示が小さくなる場合があった問題を修正
* 全体的に少し見直し
...
* イベント用ユニット編成画面にメンバー追加ボタンを追加 :  
  ユニット編成画面の上部にメンバー追加用のボタンを追加する。

* LIVEツアーカーニバル用発揮値チェック機能を追加 :  
  ユニットの予想攻発揮値が設定した値と異なる場合、LIVEボタンを非表示にしする。  
